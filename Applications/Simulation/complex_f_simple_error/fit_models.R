...
# Fit models
GPDP_cfse_250 <- fit_GPDP(X, Y, p = 0.250)
GPDP_cfse_500 <- fit_GPDP(X, Y, p = 0.500)
GPDP_cfse_950 <- fit_GPDP(X, Y, p = 0.950)
...
write_rds(GPDP_cfse_250, "GPDP_cfse_250.rds")
write_rds(GPDP_cfse_500, "GPDP_cfse_500.rds")
write_rds(GPDP_cfse_950, "GPDP_cfse_950.rds")
