...
xtable(
  mse,
  caption = "Error cuadrático promedio (datos con error de colas pesadas)",
  align = c("c","c","c"),
  label = "mse_heavy_tails"
)
xtable(
  corr,
  caption = "Correlación al cuadrado (datos con error de colas pesadas)",
  align = c("c","c","c"),
  label = "corr_heavy_tails"
)
xtable(
  100 * withn,
  caption = "Porcentaje de valores reales dentro del intervalo de confianza (datos con error de colas pesadas)",
  align = c("c","c","c"),
  digits = c(2,0,0),
